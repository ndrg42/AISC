...
for i in range(2):
    for j in range(5):
        ...
        new_row +=1
#plt.savefig('rgr_normalized_total_plots.png')
plt.show()
...
plt.savefig('Tesi_Regression_Metrics.png')
plt.show()
#%%
#Predizioni sui quasicristalli
...
plt.xlabel('Oberved critical temperature')
plt.ylabel('Predicted critical temperature')
#plt.savefig('Tesi_observed_and_predicted_values_error_bar.png')
#%%
...
plt.savefig('Tesi_Regression_avg_std.png')
#%%
import matplotlib.pyplot as plt
import matplotlib.image as image
#%%
...
for i in range(2):
    for j in range(5):
        ...
        ax[i,j].yaxis.set_visible(False)
        new_row +=1
plt.savefig('rgr_total_total_plots.png')
plt.show()
